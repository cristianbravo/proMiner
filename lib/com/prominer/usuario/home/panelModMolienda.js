...
com.prominer.usuario.home.PanelModMolienda = new Ext.extend(Ext.Panel, {
    actions: {
        guardar: null,
        opBack:null
    },
    ...
    constructor: function(config) {
        ...
        */
        this.initStores();
        com.prominer.usuario.home.PanelModMolienda.superclass.constructor.call(this, Ext.apply({
            title: 'Control de Operación Molienda',
            width : 1080,
            iconCls: 'user_mol_316',
            id: 'PanelModMoliendaId',
            height: 300,
    ...
    initStores : function(){
        ...
        this.storeTurno = new Ext.data.JsonStore({
            url : './service/modMolienda.php?accion=getTurnos',
            method : 'POST',
            root : 'results',
            idProperty: 'id',
            autoDestroy: true,
    ...
    handleActions: function(a) {
        switch (a) {
            case 'opBack':
                ...
                break;
            case 'guardar':
                var f = Ext.getCmp('formMolId').getForm();
                ...
                if (f.isValid()) {
                  f.submit({
                        url : './service/xxx.php?accion=xxx',
                        params: {
                            gridCOR:jsonGridCOR,                            
    ...
    getInternalForm: function() {
        ...
        var gridCOR =  new Ext.grid.EditorGridPanel({
                id : 'gridCORId',
                width : 605,
                title: 'Control Operacional Correa CT4',
                clicksToEdit : 1,
                height : 130,
                border : false,
                frame : true,
                ...
                columns : [
                    ...
                    {header: 'Hora', sortable : true, width : 60, dataIndex: 'hora',editor: new Ext.form.TimeField({increment: 60, format:'H:i'})},
                    {header: 'Peso', sortable : true, width : 60, dataIndex: 'colect1',editor: new Ext.form.TextField({})},
                    {header: 'Factor', sortable : true, width : 60, dataIndex: 'colect2',editor: new Ext.form.TextField({})},
                    {header: 'Ton/Hr', sortable : true, width : 60, dataIndex: 'espumante',editor: new Ext.form.TextField({})},
                    {header: 'Control Cal', sortable : true, width : 80, dataIndex: 'modif',editor: new Ext.form.TextField({})},
                    {header: 'Carga Bolas', sortable : true, width : 80, dataIndex: 'act_dep',editor: new Ext.form.TextField({})},
                    {header: 'Hora', sortable : true, width : 60, dataIndex: 'ph',editor: new Ext.form.TextField({})},
                    {header: 'Descarga %', sortable : true, width : 80, dataIndex: 'desc',editor: new Ext.form.TextField({})}
                ],
          ...
          var gridCORR =  new Ext.grid.EditorGridPanel({
                ...
                columns : [
                    ...
                    {header: 'Over %', sortable : true, width : 70, dataIndex: 'colect1',editor: new Ext.form.TextField({})},
                    {header: 'Under %', sortable : true, width : 70, dataIndex: 'colect2',editor: new Ext.form.TextField({})},
                    {header: 'Descarga %', sortable : true, width : 70, dataIndex: 'espumante',editor: new Ext.form.TextField({})},
                    {header: 'Mallaje #200', sortable : true, width : 80, dataIndex: 'modif',editor: new Ext.form.TextField({})},
                    {header: 'Flujometro', sortable : true, width : 80, dataIndex: 'act_dep',editor: new Ext.form.TextField({})},
                    {header: 'Tº', sortable : true, width : 40, dataIndex: 'cal_kil',editor: new Ext.form.TextField({})},
                    {header: 'Amperaje', sortable : true, width : 60, dataIndex: 'cal_kil',editor: new Ext.form.TextField({})}
                ],
                sm : new Ext.grid.RowSelectionModel({singleSelect : true})
            });
                ...
                items: [
                    {
                        name:'ct_op1',
                        xtype: 'radiogroup',
                        fieldLabel: 'Nivel de tolva de finos suficiente partida molienda',
                        allowBlank: false,
                        // Put all controls in a single column with width 100%
                        columns: 2,
                        items: [
                    ...
                    },                    
                    {
                        name:'ct_op2',
                        xtype: 'radiogroup',
                        fieldLabel: 'Nivel de agua en acumulador suficiente 1 turno',
                        allowBlank: false,
                        // Put all controls in a single column with width 100%
                        columns: 2,
                        items: [
                    ...
                    },
                    {
                        name:'ct_op4',
                        xtype: 'radiogroup',
                        fieldLabel: 'Área de molienda operativa',
                        allowBlank: false,
                        // Put all controls in a single column with width 100%
                        columns: 2,
                        items: [
